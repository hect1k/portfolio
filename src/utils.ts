...
export const socialLinks = {
  ...
  Codeberg: "https://codeberg.org/hect1k",
...
export const projects = [
  {
    title: "shareb.in",
    description: "A minimalist, open-source platform for ephemeral sharing of files, links, and text, built with FastAPI and PostgreSQL.",
    categories: ["webdev", "astro", "tailwindcss", "client-work"],
    image: "sharebin.jpg",
    repo: "https://codeberg.org/hect1k/sharebin",
    url: "https://shareb.in",
  },
  {
    title: "MUNDRA",
